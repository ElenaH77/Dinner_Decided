...
export default function MobileNav({ activeTab }: MobileNavProps) {
  ...
  return (
    <div className="md:hidden fixed bottom-0 w-full bg-white border-t border-[#E2E2E2] z-50 flex justify-around py-3">
      <Link href="/this-week" className="flex flex-col items-center">
      ...
      <Link href="/grocery" className="flex flex-col items-center">
      ...
      <Link href="/dinnerbot" className="flex flex-col items-center">
